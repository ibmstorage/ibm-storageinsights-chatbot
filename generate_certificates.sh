...
# 1. Creates "frontend/certificates" and "backend/certficates" directories if they don't already exist.
# 2. Generates a private key (server.key).
...
# Step 4: Copy the .key and .crt files to both frontend and backend certficates directories
...
# Success message
echo "Self-signed certificate and private key have been generated and copied to frontend/certificates and backend/certificates."
